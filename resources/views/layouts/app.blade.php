...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Material+Icons"><!-- Styles -->
        ...
        <nav class="navbar navbar-light">
            <a class="navbar-brand" href="/">Keep up with your appointments</a>
                <ul class="navbar-nav">
                    @if (Route::has('login'))
                            @auth
                            <li class="nav-item"><a class="nav-link" href="{{ url('/home') }}">Welcome, {{Auth::user()->name}}</a></li>
